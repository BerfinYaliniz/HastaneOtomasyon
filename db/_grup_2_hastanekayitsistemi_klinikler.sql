...
CREATE TABLE `klinikler` (
  ...
  `klinik_adi` varchar(50) DEFAULT NULL,
...
INSERT INTO `klinikler` VALUES (1,'Diş Hekimliği'),(2,'Aile Hekimliği'),(3,'Algoloji'),(4,'Amatem'),(5,'Anesteziyoloji ve Reanimasyon'),(6,'Beyin ve Sinir Cerrahisi'),(7,'Çocuk Sağlığı ve Hastalıkları'),(8,'Endodonti'),(9,'Deri ve Zührevi Hastalıkları'),(10,'Fiziksel Tıp ve Rehabilitasyon'),(11,'Genel Cerrahi'),(12,'Göğüs Hastalıkları'),(13,'Göz Hastalılkları');
